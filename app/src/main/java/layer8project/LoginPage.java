...
public class LoginPage {
    ...
    public LoginPage(UserManager userManager, ModuleManager moduleManager, ProgressRepository progressRepository) {
        ...
        User user = userManager.userLogin(loginUsername, loginPassword);
            if (user != null) {
                ...
                frame.dispose();
                new HomePage(user, userProgress, userManager, moduleManager, progressRepository);
                } else {
